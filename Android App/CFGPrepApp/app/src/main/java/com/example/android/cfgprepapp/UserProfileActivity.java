...
import com.example.android.cfgprepapp.fragment.ProfileTabShopFragment;
import com.example.android.cfgprepapp.fragment.ProfileTabSocialFragment;
import com.example.android.cfgprepapp.fragment.ProfileTabUserDetailFragment;
...
public class UserProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            if(position == 0) {
                return ProfileTabUserDetailFragment.newInstance(position,user_id);
            }
            else if(position == 1) {
                return ProfileTabShopFragment.newInstance(position);
            }
            else{
                return ProfileTabSocialFragment.newInstance(position);
            }
        }
    }
