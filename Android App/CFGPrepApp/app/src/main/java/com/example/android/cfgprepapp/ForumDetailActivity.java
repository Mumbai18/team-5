...
public class ForumDetailActivity extends AppCompatActivity implements ForumansAdapter.ForumansAdapterOnClickHandler{
    ...
    private String TAG = ForumDetailActivity.class.getSimpleName();
    private ForumDetailActivity.GetForumans mTask;
