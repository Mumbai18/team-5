...
public class ProfileTabShopFragment extends Fragment implements OnClickListener {
	...
	public static ProfileTabShopFragment newInstance(int position) {
		ProfileTabShopFragment f = new ProfileTabShopFragment();
		Bundle b = new Bundle();
