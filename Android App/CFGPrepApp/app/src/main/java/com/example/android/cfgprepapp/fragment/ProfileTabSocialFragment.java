...
public class ProfileTabSocialFragment extends Fragment implements OnClickListener {
	...
	public static ProfileTabSocialFragment newInstance(int position) {
		ProfileTabSocialFragment f = new ProfileTabSocialFragment();
		Bundle b = new Bundle();
