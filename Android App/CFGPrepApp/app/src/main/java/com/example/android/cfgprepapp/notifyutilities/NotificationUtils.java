...
public class NotificationUtils {
    ...
    private static Action incAction(Context context) {
        ...
        incrementCountIntent.setAction(ReminderTasks.ACTION_INCREMENT_COUNT);
    ...
    private static Bitmap largeIcon(Context context) {
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(res, R.drawable.background_small);
        return largeIcon;
    }
}