...
public class TabUserDetailFragment extends Fragment implements OnClickListener {
	...
	public static TabUserDetailFragment newInstance(int position) {
		TabUserDetailFragment f = new TabUserDetailFragment();
		Bundle b = new Bundle();
