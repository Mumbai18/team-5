...
public class ProfileTabUserDetailFragment extends Fragment implements OnClickListener {
	...
	public static ProfileTabUserDetailFragment newInstance(int position, String user_id) {
		//Setting the profile id passed by the previous fragment
		profile_user_id=user_id;

		ProfileTabUserDetailFragment f = new ProfileTabUserDetailFragment();
		Bundle b = new Bundle();
